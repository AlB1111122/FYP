...
INCLFLAGS = -I$(CROSSCOMP_TOOLCHAIN_DIR)/aarch64-none-elf/include -I$(ETL_INSTALL_DIR)/include -I$(CROSSCOMP_TOOLCHAIN_DIR)/lib/gcc/aarch64-none-elf/13.3.1/include -I./include
