...
LINKFLAG = -lc -lg -lm
COMPFLAGS = -Wall -O3 -ffreestanding -nostdinc -nostdlib -nostartfiles -mstrict-align -fno-exceptions -fpermissive -ftree-vectorize -march=armv8-a+simd -mcpu=cortex-a72
